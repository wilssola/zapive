...
const en = {
  ...
  "gif.keyless": "Searching openly licensed GIFs — add a Giphy key in Settings for a wider catalogue",
  "gif.noResults": "No GIFs found",
  "gif.keySaved": "Giphy key saved.",
  "gif.keyCleared": "Giphy key removed.",
...
const pt: Record<MessageKey, string> = {
  ...
  "gif.keyless": "Buscando GIFs de licen\u00e7a aberta \u2014 adicione uma chave do Giphy nas Configura\u00e7\u00f5es para um cat\u00e1logo maior",
  "gif.noResults": "Nenhum GIF encontrado",
  "gif.keySaved": "Chave do Giphy salva.",
  "gif.keyCleared": "Chave do Giphy removida.",
