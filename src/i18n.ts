...
const en = {
  ...
  "gif.needKey": "Add a Giphy API key in Settings to search GIFs — showing GIFs from your chats",
...
const pt: Record<MessageKey, string> = {
  ...
  "gif.needKey": "Adicione uma chave da API do Giphy nas Configura\u00e7\u00f5es para buscar GIFs \u2014 mostrando GIFs das suas conversas",
